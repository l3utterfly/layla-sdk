...
- Read the [SDK API reference](docs/sdk-api.md) for imports, chat completions, streaming, chat sessions, session history, characters, image generation, abort handling, and errors.
