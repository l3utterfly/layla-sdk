...
- Read the [SDK API reference](docs/sdk-api.md) for imports, chat completions, streaming, chat sessions, session history, message saves, scheduled chat messages, memory list/top/save APIs, personas, TTS voices, playback and stop controls, characters, image generation, file utilities, abort handling, and errors.
